...
/*]]>*/
	 ...
	 *
	 * @param string $getEnvName Name of the "environment variable"/"server variable" you wish to use. Valid values are SCRIPT_NAME, SCRIPT_FILENAME, REQUEST_URI, ORIG_PATH_INFO, REMOTE_ADDR, REMOTE_HOST, HTTP_REFERER, HTTP_HOST, HTTP_USER_AGENT, HTTP_ACCEPT_LANGUAGE, QUERY_STRING, TYPO3_DOCUMENT_ROOT, TYPO3_HOST_ONLY, TYPO3_HOST_ONLY, TYPO3_REQUEST_HOST, TYPO3_REQUEST_URL, TYPO3_REQUEST_SCRIPT, TYPO3_REQUEST_DIR, TYPO3_SITE_URL, _ARRAY
		...
		/*
			...
			URL:	http://username:password@192.168.1.4:8080/typo3/32/temp/phpcheck/index.php/arg1/arg2/arg3/?arg1,arg2,arg3&p1=parameter1&p2[key]=value#link1
				...
				Further definition: [path_script] = '/typo3/32/temp/phpcheck/index.php'
									...
									[ORIG_PATH_INFO] = '/arg1/arg2/arg3/'
									[path] = [path_script/path_dir][ORIG_PATH_INFO]
			...
			URI______:
				...
				ORIG_PATH_INFO		=	[ORIG_PATH_INFO]			= /arg1/arg2/arg3/
		...
		switch ((string) $getEnvName) {
			case 'SCRIPT_NAME':
				$retVal = (PHP_SAPI == 'fpm-fcgi' || PHP_SAPI == 'cgi' || PHP_SAPI == 'cgi-fcgi') &&
						($_SERVER['ORIG_ORIG_PATH_INFO'] ? $_SERVER['ORIG_ORIG_PATH_INFO'] : $_SERVER['ORIG_PATH_INFO']) ?
						($_SERVER['ORIG_ORIG_PATH_INFO'] ? $_SERVER['ORIG_ORIG_PATH_INFO'] : $_SERVER['ORIG_PATH_INFO']) :
			...
			case 'REQUEST_URI':
				...
				break;
			case 'ORIG_PATH_INFO':
					// $_SERVER['ORIG_PATH_INFO']!=$_SERVER['SCRIPT_NAME'] is necessary because some servers (Windows/CGI) are seen to set ORIG_PATH_INFO equal to script_name
					// Further, there must be at least one '/' in the path - else the ORIG_PATH_INFO value does not make sense.
					// IF 'ORIG_PATH_INFO' never works for our purpose in TYPO3 with CGI-servers, then 'PHP_SAPI=='cgi'' might be a better check. Right now strcmp($_SERVER['ORIG_PATH_INFO'],t3lib_div::getIndpEnv('SCRIPT_NAME')) will always return FALSE for CGI-versions, but that is only as long as SCRIPT_NAME is set equal to ORIG_PATH_INFO because of PHP_SAPI=='cgi' (see above)
					//				if (strcmp($_SERVER['ORIG_PATH_INFO'],self::getIndpEnv('SCRIPT_NAME')) && count(explode('/',$_SERVER['ORIG_PATH_INFO']))>1)	{
				if (PHP_SAPI != 'cgi' && PHP_SAPI != 'cgi-fcgi' && PHP_SAPI != 'fpm-fcgi') {
					$retVal = $_SERVER['ORIG_PATH_INFO'];
				}
				break;
